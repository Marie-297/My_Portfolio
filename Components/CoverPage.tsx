...
const CoverPage = () => {
  return (
    <div className='text-center'>
      <h2 className='uppercase text-center tracking-widest text-white dark:text-black text-md md:text-xl lg:text-2xl mb-2 lg:mb-6 font-extrabold'>Software Developer</h2>
      <TextGenerateEffect 
      ...
      />
      <p className='text-white dark:text-black font-bold sm:text-xs italic'>Welcome to <span className='font-extrabold text-white text-lg'>Marie's Portfolio</span>, Innovative Solution for a digital world.</p>

...
const aboutInfo = {
  ...
  Info: [
    ...
    {fieldName: "LinkedIn",
      fieldValue: "https://www.linkedin.com/in/mariama-seidu-935457284/"
    },
  ]
}
...
const educationInfo = {
  ...
  items: [
    ...
    {institution: "I.P.M.C.",
      degree: "Certificate in MS-Word, Excel, Advanced Excel and PowerPoints",
      duration: "2008",
...
const experienceInfo = {
  ...
  items: [
    ...
    {company: "Codetrain",
      ...
      location: "Accra - Ghana",
      responsibilities: ["Built a fully responsive Leave management app for a company based in Ghana with other", "Collaborated with other Students to build an interesting game-app", "Built various reponsive static Web applications"]
    },
  ]
}
